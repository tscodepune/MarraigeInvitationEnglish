...
$(document).on('ready', function () {
    ...
    $('.other-menu').on('mouseenter', function () {
     ...
     // JavaScript Document
   var today = new Date();
   var target = new Date('04/04/2021 12:21:00'); //Enter Target date & time - MM/DD/YYYY hh:mm:ss
   var startdate = new Date('02/27/2021'); //Enter Timer start date or Today's date - MM/DD/YYYY
   ...
   if ($.find('#example').length) {
       $('#example').countdown({
           date: '04/04/2021 12:21:00', //Enter Target date & time - MM/DD/YYYY hh:mm:ss
           offset: +5.5,
           day: 'Day',
           days: 'Days'
       }, function () {
